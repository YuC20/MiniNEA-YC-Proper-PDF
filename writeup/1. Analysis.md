...
![image](https://github.com/user-attachments/assets/763efcfa-98dd-453f-b475-b693f91cein 1980. Each console only contained one game (depending on the model of the device) due to hardware restrictions and the design philosophy (a small portable device) at the time. ...

## PRIMARY USER AND STAKEHOLDER
When looking into starting my project I need to first analyze my potential stakeholders and users that will be interacting with my product. ...

## Research on Game and Watch Games
